...
LAZY_DEPS: dict[str, tuple[str, ...]] = {
    ...
    "tool.dashboard": (
        ...
        "starlette==1.3.1",  # 2026 security advisory rollup — keep lazy-install in sync with pyproject [web]
        "python-multipart==0.0.31",  # 2026 security advisory rollup; FastAPI UploadFile/Form (NS-501)
    ),
    ...
    "tool.computer_use": (
        "mcp==1.28.1",
        "starlette==1.3.1",  # 2026 security advisory rollup — keep in sync with pyproject [computer-use]
    ),
